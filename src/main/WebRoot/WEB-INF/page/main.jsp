...
//                            width: "100%"
                    ...
                    success: function (result) {
                        if (result.code == 0) {
                            ...
                            for (var i in obj) {
                                var item = obj[i];
                                var dtItem = {
                                    "deviceCategory": removeempetconnect(item.deviceCategory,"",""),
                                    "createdDate": removeempetconnect(item.createdDate,"",""),
                                    "isDeleted": removeempetconnect(item.isDeleted,"",""),
                                    "ip": removeempetconnect(item.ip,"",""),
                                    "modifiedDate": removeempetconnect(item.modifiedDate,"",""),
                                    "deviceSeriaNumber": removeempetconnect(item.deviceSeriaNumber,"",""),
                                    "tabDeviceGroupId": removeempetconnect(item.tabDeviceGroupId,"",""),
                                    "tabDeviceFreshairId": removeempetconnect(item.tabDeviceFreshairId,"",""),
                                    "name":removeempetconnect(item.name,"","")
                                };
                            ...
                            for (var i in freshDeviceArr) {
                                var showName = ("" == freshDeviceArr[i].name) ? freshDeviceArr[i].deviceSeriaNumber : freshDeviceArr[i].name;
                                dialog += '<div class="form-group"><div class="freshDevice-item" id="freshDevice_'+freshDeviceArr[i].deviceSeriaNumber+'"  required>'+showName+'</div></div>' ;
                            }
        ...
        function reloadPageContent(deviceGroup) {
            currentFreshDeviceSeriaNumber = "";
            currentFreshairDeviceTabId = "";
            if (!deviceGroup) {
                return;
            }
