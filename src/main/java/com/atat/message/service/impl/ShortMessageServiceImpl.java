...
public class ShortMessageServiceImpl implements ShortMessageService {
    protected  final Logger logger = LoggerFactory.getLogger(ShortMessageServiceImpl.class);
    ...
    public  Integer sendShortMessage(String mobelPhone, String msmContent) {
        try {
            ...
            paramMap.put("Psw", smsPlatformProperties.getProperty("pwd"));
            paramMap.put("Name", smsPlatformProperties.getProperty("name"));
            paramMap.put("Id", smsPlatformProperties.getProperty("id"));
